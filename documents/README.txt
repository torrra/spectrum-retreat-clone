...
///FOOT STEP
Foot step sound : https://pixabay.com/fr/sound-effects/steps-in-corridor-104456/ by Pixabay
...
///RAY
Ray sound : https://lasonotheque.org/detail-1758-blaster-star-wars-2.html by Joseph STARDIN

N'hésitez pas à :
- Mettre dans vos génériques : "Sons additionnels : Joseph SARDIN - LaSonotheque.org".
- Mettre un lien cliquable dans vos infos de vidéo youtube, site internet, crédits, etc. : "https://BigSoundBank.com" (je préfère les liens vers la version internationnal du site).
- Me contacter pour m'envoyer un lien vers votre projet fini, que je le partage.
- Faire un petit don, ou commander sur Thomann en passant par ce lien (ça soutien LaSonotheque) !
Rien n'est obligatoire, mais forcement apprécié...

Vous êtes autorisé à :
- Partager, copier, distribuer et communiquer le matériel par tous moyens et sous tous formats.
- Adapter, remixer, transformer et créer à partir du matériel.
- Utiliser, y compris à des fins commerciales.
- Sans aucune restriction.
- Sans avoir besoin de demander l'autorisation.

Cela s'apparente à :
- La licence CC0 1.0 universel, de Creative Commons.
- La licence WTFPL, que certain résument : Faites ce que vous voulez, j'en ai RIEN à FAIRE.
- Le domaine public.


///CLOSE DOOR
Close door sound : https://pixabay.com/fr/sound-effects/sci-fi-sound-effect-designed-circuits-sfx-tonal-15-202059/ by Pixabay
...
17.EU Monthly Active Users.
In accordance with requirements under the EU Digital Services Act, the average number of EU monthly active users of the Service between July 2023 - December 2023 was 5,482,176. For more on Pixabay and the Digital Services Act see here.


///DIGITAL SERVICE ACT (DSA)

Digital Services Act (DSA) Guidelines
This page sets out information relevant to the European Union’s (EU) Digital Services Act (DSA), a set of regulations designed to prevent illegal and harmful activities online.

The DSA applies to Pixabay users in the EU.

EU Users:
For DSA-related inquiries, reach out to our designated point of contact at info@pixabay.com.

Reporting Illegal Content:
Users, trusted flaggers, and the public can report content that may be illegal in the EU via Pixabay's in-product reporting. Simply hover over the media and click the flag icon to report a violation. Alternatively, reports can be submitted via this form.

Appeals and Dispute Resolution for EU Users:
Appeals: Disagree with a moderation decision (including where you have reported content as violating EU law)? You have 180 days to appeal by emailing info@pixabay.com. Our appeals process is outlined in detail in our FAQs under 'Content Moderation'.
...
Authorities:
For member states’ authorities, the European Commission, and the European Board for Digital Services, contact us at info@pixabay.com for DSA-related inquiries and orders submitted in accordance with articles 9(2) and 10(2) of the DSA.

Please ensure all requests are made in English or German.
